    ...
    public static function duplicate(oArray:Object, bRecursive:Boolean = false):Object {
      ...
      if(bRecursive) {
        if(oArray is Array) {
          ...
          var oDuplicate2:Object = new Object();
          for(var sItem:String in oArray) {
            if(oArray[sItem] is Object && !(oArray[sItem] is String) && !(oArray[sItem] is Boolean) && !(oArray[sItem] is Number)) {
              oDuplicate2[sItem] = duplicate(oArray[sItem], bRecursive);
            }
            else {
              oDuplicate2[sItem] = oArray[sItem];
            }
          }
          return oDuplicate2;
        }
        ...
        if(oArray is Array) {
          ...
          var oDuplicate3:Object = new Object();
          for(var sItem2:String in oArray) {
            oDuplicate3[sItem2] = oArray[sItem2];
          }
          return oDuplicate3;
        }
      }
